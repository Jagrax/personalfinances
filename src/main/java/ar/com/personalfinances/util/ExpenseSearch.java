...
public class ExpenseSearch {
    ...
    public List<FilterChip> getActiveFilters() {
        ...
        if (StringUtils.hasText(description) || FilterOperator.EMPTY.equals(descriptionOperator) || FilterOperator.NOT_EMPTY.equals(descriptionOperator)) chips.add(new FilterChip("description", "Descripción", descriptionOperator, description));
